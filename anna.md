...
- YouTube and Instagram can use Composio managed auth configs in the current local runtime.
- TikTok managed auth is not available for this project/toolkit; use a custom OAuth auth config with TikTok client credentials.
